...
import 'search_medicine_copy2_model.dart';
export 'search_medicine_copy2_model.dart';

class SearchMedicineCopy2Widget extends StatefulWidget {
  const SearchMedicineCopy2Widget({super.key});

  @override
  State<SearchMedicineCopy2Widget> createState() =>
      _SearchMedicineCopy2WidgetState();
}

class _SearchMedicineCopy2WidgetState extends State<SearchMedicineCopy2Widget> {
  late SearchMedicineCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchMedicineCopy2Model());
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((_model.textFieldTextController.text != '') &&
                            ...
                            Expanded(
                              child: Builder(
                                builder: (context) {
                                  final medicine =
                                      MedicineSearchTestCall.medicineData(
                                            (_model.searchtext?.jsonBody ?? ''),
                                          )?.toList() ??
                                          [];
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              alignment: const AlignmentDirectional(
                                                  1.06, -0.04),
                                              child: wrapWithModel(
                                                model: _model.addtocartModels
                                                    .getModel(
                                                  medicineIndex.toString(),
                                                  medicineIndex,
                                                ),
                                                updateCallback: () =>
                                                    safeSetState(() {}),
                                                ...
                                                child: AddtocartWidget(
                                                  key: Key(
                                                    'Key4u1_${medicineIndex.toString()}',
                                                  ),
                                                  ...
                                                  imageurl: getJsonField(
                                                      ...
                                                      : functions.singleimageToList(
                                                          containerAppResourcesRecord!
                                                              .defaultMedicineImageCart),
                                                  image: containerAppResourcesRecord!
                                                      .defaultMedicineImageCart,
                                                ),
                                              ),
                                            ),
                          ...
                          if (_model.loading ?? true)
                            wrapWithModel(
                              model: _model.medicineshimmerModel,
                              updateCallback: () => safeSetState(() {}),
                              child: const MedicineshimmerWidget(),
                            ),

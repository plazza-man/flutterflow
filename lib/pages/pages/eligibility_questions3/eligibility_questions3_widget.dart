...
import 'eligibility_questions3_model.dart';
export 'eligibility_questions3_model.dart';

class EligibilityQuestions3Widget extends StatefulWidget {
  const EligibilityQuestions3Widget({super.key});

  @override
  State<EligibilityQuestions3Widget> createState() =>
      _EligibilityQuestions3WidgetState();
}

class _EligibilityQuestions3WidgetState
    extends State<EligibilityQuestions3Widget> {
  late EligibilityQuestions3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EligibilityQuestions3Model());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.formKey.currentState == null ||
                        ...
                        safeSetState(() => _model.output3 = false);
                        return;
                      }

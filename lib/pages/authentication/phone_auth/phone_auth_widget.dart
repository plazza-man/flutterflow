  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<AppResourcesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppResourcesRecord> phoneAuthAppResourcesRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final phoneAuthAppResourcesRecord =
            phoneAuthAppResourcesRecordList.isNotEmpty
                ? phoneAuthAppResourcesRecordList.first
                : null;
